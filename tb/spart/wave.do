...
add wave -noupdate -radix hexadecimal /spart_tb/tx_fifo_stim
add wave -noupdate /spart_tb/tx_fifo_ind
add wave -noupdate /spart_tb/tx_fifo_half_full
add wave -noupdate /spart_tb/STIM_QUEUE_SIZE
add wave -noupdate -radix hexadecimal /spart_tb/srb_reg_temp
add wave -noupdate /spart_tb/spart_tx
add wave -noupdate /spart_tb/spart_rx
add wave -noupdate /spart_tb/rx_q_empty
add wave -noupdate -radix hexadecimal /spart_tb/rx_fifo_stim
add wave -noupdate /spart_tb/rx_fifo_ind
add wave -noupdate /spart_tb/rx_fifo_half_full
add wave -noupdate /spart_tb/rst_n
add wave -noupdate /spart_tb/QUEUE_SIZE
add wave -noupdate /spart_tb/db_high_temp
add wave -noupdate /spart_tb/clk
add wave -noupdate /spart_tb/both_fifo_ind
add wave -noupdate /spart_tb/ADDR_SREG
add wave -noupdate /spart_tb/ADDR_DBUF
add wave -noupdate /spart_tb/ADDR_DBL
add wave -noupdate /spart_tb/ADDR_DBH
...
add wave -noupdate -expand -group {Spart Reg Bus} -color Magenta -radix hexadecimal -childformat {{{/spart_tb/srb/databus[7]} -radix hexadecimal} {{/spart_tb/srb/databus[6]} -radix hexadecimal} {{/spart_tb/srb/databus[5]} -radix hexadecimal} {{/spart_tb/srb/databus[4]} -radix hexadecimal} {{/spart_tb/srb/databus[3]} -radix hexadecimal} {{/spart_tb/srb/databus[2]} -radix hexadecimal} {{/spart_tb/srb/databus[1]} -radix hexadecimal} {{/spart_tb/srb/databus[0]} -radix hexadecimal}} -subitemconfig {{/spart_tb/srb/databus[7]} {-color Magenta -height 16 -radix hexadecimal} {/spart_tb/srb/databus[6]} {-color Magenta -height 16 -radix hexadecimal} {/spart_tb/srb/databus[5]} {-color Magenta -height 16 -radix hexadecimal} {/spart_tb/srb/databus[4]} {-color Magenta -height 16 -radix hexadecimal} {/spart_tb/srb/databus[3]} {-color Magenta -height 16 -radix hexadecimal} {/spart_tb/srb/databus[2]} {-color Magenta -height 16 -radix hexadecimal} {/spart_tb/srb/databus[1]} {-color Magenta -height 16 -radix hexadecimal} {/spart_tb/srb/databus[0]} {-color Magenta -height 16 -radix hexadecimal}} /spart_tb/srb/databus
add wave -noupdate -expand -group SPART /spart_tb/iDUT/tx_queue_write
add wave -noupdate -expand -group SPART /spart_tb/iDUT/tx_queue_in
add wave -noupdate -expand -group SPART -divider {Begin FIFO signals}
add wave -noupdate -expand -group SPART -color Orange /spart_tb/iDUT/tx_q_full
add wave -noupdate -expand -group SPART -color Orange /spart_tb/iDUT/tx_q_empty_n
add wave -noupdate -expand -group SPART -color Orange -radix hexadecimal /spart_tb/iDUT/tx_old_ptr
add wave -noupdate -expand -group SPART -color Orange -radix hexadecimal /spart_tb/iDUT/tx_new_ptr
add wave -noupdate -expand -group SPART -color Orange /spart_tb/iDUT/rx_q_full_n
add wave -noupdate -expand -group SPART -color Orange /spart_tb/iDUT/rx_q_empty
add wave -noupdate -expand -group SPART -color Orange -radix hexadecimal /spart_tb/iDUT/rx_old_ptr
add wave -noupdate -expand -group SPART -color Orange -radix hexadecimal /spart_tb/iDUT/rx_new_ptr
add wave -noupdate -expand -group SPART -divider {End FIFO signals}
add wave -noupdate -expand -group SPART /spart_tb/iDUT/tx_data
add wave -noupdate -expand -group SPART /spart_tb/iDUT/TX
add wave -noupdate -expand -group SPART /spart_tb/iDUT/status_reg
add wave -noupdate -expand -group SPART /spart_tb/iDUT/rx_queue_write
add wave -noupdate -expand -group SPART /spart_tb/iDUT/rx_queue_out
add wave -noupdate -expand -group SPART /spart_tb/iDUT/rx_data
add wave -noupdate -expand -group SPART /spart_tb/iDUT/RX
add wave -noupdate -expand -group SPART /spart_tb/iDUT/rst_n
add wave -noupdate -expand -group SPART /spart_tb/iDUT/new_data_ready
add wave -noupdate -expand -group SPART /spart_tb/iDUT/iorw_n
add wave -noupdate -expand -group SPART /spart_tb/iDUT/iocs_n
add wave -noupdate -expand -group SPART /spart_tb/iDUT/ioaddr
...
add wave -noupdate -expand -group SPART /spart_tb/iDUT/databus
...
add wave -noupdate -expand -group SPART /spart_tb/iDUT/clk
add wave -noupdate -group rx_queue /spart_tb/iDUT/rx_queue/clk
...
add wave -noupdate -group tx_queue /spart_tb/iDUT/tx_queue/clk
...
add wave -noupdate -group uart_tx /spart_tb/iDUT/uart_tx/clk
add wave -noupdate -group uart_tx /spart_tb/iDUT/uart_tx/rst_n
...
add wave -noupdate -group uart_tx -radix hexadecimal /spart_tb/iDUT/uart_tx/BAUD_CNT_REF
...
add wave -noupdate -expand -group Memory -radix hexadecimal /spart_tb/iDUT/tx_queue/mem
add wave -noupdate -expand -group Memory -radix hexadecimal /spart_tb/iDUT/rx_queue/mem
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 2} {208490000 ps} 1} {{Cursor 3} {1332681500 ps} 0} {{Cursor 5} {156390000 ps} 1}
